      ...
      <Card className="mt-8 p-5">
        ...
        <div className="mt-4 grid gap-3">
          {activities.map((activity) => (
            <div
              key={activity.text}
              className="flex items-center gap-3 rounded-xl bg-[var(--color-bg-tertiary)] p-3"
            >
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[var(--color-card-bg)] text-[var(--color-text-brand)] shadow-sm">
