...
export function ZoomablePreview({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="relative flex h-full w-full overflow-hidden">
      {/* Zoom controls */}
      <div className="absolute bottom-3 left-1/2 z-10 flex -translate-x-1/2 items-center gap-1 rounded-full border border-[var(--color-card-border)] bg-[var(--color-card-bg)]/90 px-2 py-1 shadow-md backdrop-blur-sm">
        <Button
          variant="ghost"
          size="icon"
        ...
        <span className="min-w-[3.5rem] text-center text-xs font-semibold text-[var(--color-text-secondary)]">
